...
public class CameraShaker : Singleton<CameraShaker>
{
	...
	private void Update()
	{
		...
		{
			if (_isGlobalShake)
				_shaker.m_AmplitudeGain = Mathf.Lerp(0f, globalInitialAmplitude, _remainingTime / globalShakeDuration);
			else
				_shaker.m_AmplitudeGain = Mathf.Lerp(0f, _localInitialAmplitude, _remainingTime / _localShakeDuration);
